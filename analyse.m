...
connection_matrix = [2 -1 0;-1 2 -1;0 -1 1];
K = k*connection_matrix; % create the stiffness matrix 
C = c*connection_matrix; % create the damping matrix
...
for w = 1:130;
  ...
  disp = B \ [1;0;0];       % harmonic response at floor 1
